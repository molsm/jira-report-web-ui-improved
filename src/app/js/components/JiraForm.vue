<template>
    <div class="form">
        <form v-on:submit="getReport" action="#" method="post">
            ...
            <!-- I'm too lazy to do dynamical form creation, I know that's shitcode x( -->

            <div class="field" >
                <div class="button" v-on:click="jiraForm.isHidden = !jiraForm.isHidden">Use second form</div>
            </div>
            <div id="second-form" v-if="!jiraForm.isHidden">
                <div class="field">
                    <label class="label">Tempo Token</label>
                    <div class="control">
                        <input type="password" class="input" placeholder="Tempo token"
